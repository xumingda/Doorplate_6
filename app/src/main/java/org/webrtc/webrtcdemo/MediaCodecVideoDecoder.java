...
class MediaCodecVideoDecoder {
  ...
  @SuppressLint("NewApi") public void dispose() {
    codec.stop();
    codec.release();
  }
  ...
  @SuppressLint("NewApi") private boolean setCodecState(int width, int height, CodecName codecName) {
  ...
  @SuppressLint("NewApi") private void decodePendingBuffers() {
  ...
  @SuppressLint("NewApi") private boolean feedInputBuffer() {
  ...
  // to deliver.
  @SuppressLint("NewApi") private boolean drainOutputBuffer() {
