...
public class MediaEngine implements VideoDecodeEncodeObserver {
  ...
  @SuppressLint("NewApi") private static int rotationFromRealWorldUp(CameraInfo info,
                                             int deviceRotation) {
  ...
  @SuppressLint("NewApi") public MediaEngine(Context context) {
  ...
  @SuppressLint("NewApi") public boolean hasMultipleCameras() {
  ...
  @SuppressLint("NewApi") private int getCameraId(int index) {
