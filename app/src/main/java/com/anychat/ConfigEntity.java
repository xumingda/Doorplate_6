...
public class ConfigEntity {
	...
	public static final int VIDEO_QUALITY_NORMAL = 2;		// 普???视频质??
	...
	public int fixcolordeviation = 0;						// 修正本地视频采集偏色??0 关闭(默认）， 1 ????
	public int videoShowGPURender = 0;						// 视频数据通过GPU直接渲染??0  关闭(默认)?? 1 ????
	public int videoAutoRotation = 1;						// 本地视频自动旋转控制（参数为int型， 0表示关闭?? 1 ??启[默认]，视频旋转时??要参考本地视频设备方向参数）
