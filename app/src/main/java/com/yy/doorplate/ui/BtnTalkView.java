...
public class BtnTalkView extends AppCodeView implements OnClickListener {
	...
	public BtnTalkView(Context context, MyApplication application,
	...
	public void initView() {
		...
		View.inflate(context, R.layout.ly_btn_talk, this);
		button = (Button) findViewById(R.id.btn_main_talk);
