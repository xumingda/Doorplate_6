...
public class BtnControlView extends AppCodeView implements OnClickListener {
	...
	public BtnControlView(Context context, MyApplication application,
	...
	public void initView() {
		...
		View.inflate(context, R.layout.ly_btn_control, this);
		button = (Button) findViewById(R.id.btn_main_control);
