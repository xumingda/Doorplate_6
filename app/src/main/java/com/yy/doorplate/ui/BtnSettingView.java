...
public class BtnSettingView extends AppCodeView implements OnClickListener {
	...
	public BtnSettingView(Context context, MyApplication application,
	...
	public void initView() {
		...
		View.inflate(context, R.layout.ly_btn_setting, this);
		button = (Button) findViewById(R.id.btn_main_setting);
