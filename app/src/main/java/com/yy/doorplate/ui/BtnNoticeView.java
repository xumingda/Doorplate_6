...
import com.yy.doorplate.activity.NoticeListActivity;

public class BtnNoticeView extends AppCodeView {

	private Button button;

	public BtnNoticeView(Context context, MyApplication application,
			String nextPath) {
	...
	public void initView() {
		...
		View.inflate(context, R.layout.ly_btn_notice, this);
