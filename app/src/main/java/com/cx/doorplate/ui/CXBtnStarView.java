...
public class CXBtnStarView extends AppCodeView {

	private Button button;

	public CXBtnStarView(Context context, MyApplication application,
			String nextPath) {
	...
	public void initView() {
		...
		View.inflate(context, R.layout.cx_ly_btn_star, this);
		button = (Button) findViewById(R.id.cx_btn_app_star);
