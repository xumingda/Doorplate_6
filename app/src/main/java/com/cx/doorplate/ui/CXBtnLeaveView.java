...
public class CXBtnLeaveView extends AppCodeView {

	private Button button;

	public CXBtnLeaveView(Context context, MyApplication application,
			String nextPath) {
	...
	public void initView() {
		...
		View.inflate(context, R.layout.cx_ly_btn_leave, this);
		button = (Button) findViewById(R.id.cx_btn_app_leave);
