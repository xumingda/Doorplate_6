...
public class CXBtnBjtzView extends AppCodeView {

	private Button button;

	public CXBtnBjtzView(Context context, MyApplication application,
			String nextPath) {
	...
	public void initView() {
		...
		View.inflate(context, R.layout.cx_ly_btn_bjtz, this);
		button = (Button) findViewById(R.id.cx_btn_app_bjtz);
