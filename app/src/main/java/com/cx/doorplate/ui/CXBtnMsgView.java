...
public class CXBtnMsgView extends AppCodeView {

	private Button button;

	public CXBtnMsgView(Context context, MyApplication application,
			String nextPath) {
	...
	public void initView() {
		...
		View.inflate(context, R.layout.cx_ly_btn_msg, this);
		button = (Button) findViewById(R.id.cx_btn_mian_msg);
