...
public class CXBtnWeatherView extends AppCodeView {

	private Button button;

	public CXBtnWeatherView(Context context, MyApplication application,
			String nextPath) {
	...
	public void initView() {
		...
		View.inflate(context, R.layout.cx_ly_btn_weather, this);
		button = (Button) findViewById(R.id.cx_btn_app_weather);
