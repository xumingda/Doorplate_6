...
public class CXBtnControlView extends AppCodeView implements OnClickListener {
	...
	public CXBtnControlView(Context context, MyApplication application,
	...
	public void initView() {
		...
		View.inflate(context, R.layout.cx_ly_btn_control, this);
		button = (Button) findViewById(R.id.btn_main_msg);
		...
		case R.id.btn_premission_login:
			...
			if (!TextUtils.isEmpty(name) && !TextUtils.isEmpty(pwd)) {
				...
				if (userInfoDatabase.query_by_userName(name, pwd) != null) {
					...
					if (application.operateType.equals("CONTROL")) {
						application
								.openOrvibo("1", userInfoDatabase
										.query_by_userName(name, pwd).userName);
					}
					return;
				}
