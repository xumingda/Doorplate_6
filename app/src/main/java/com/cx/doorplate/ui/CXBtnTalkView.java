...
public class CXBtnTalkView extends AppCodeView implements OnClickListener {
	...
	public CXBtnTalkView(Context context, MyApplication application,
	...
	public void initView() {
		...
		View.inflate(context, R.layout.cx_ly_btn_talk, this);
		button = (Button) findViewById(R.id.cx_btn_app_talk);
